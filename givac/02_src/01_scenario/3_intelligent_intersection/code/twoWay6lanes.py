...
def main():
    sumo_cmd = ['sumo-gui', '--duration-log.statistics', '--tripinfo-output', 'my_output_file2.xml', '-c', '../../02-3_intelligent_intersection/set/twoWay6lanes.sumo.cfg']
